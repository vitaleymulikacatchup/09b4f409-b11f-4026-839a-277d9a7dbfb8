...
export const metadata: Metadata = {
  title: "AutoHub - Premium Cars & Vehicles for Sale",
  description: "Discover premium vehicles, flexible financing options, and exceptional service at AutoHub. Browse our curated inventory of new and pre-owned cars.",
  keywords: "car dealership, vehicle sales, auto financing, premium cars, new and used vehicles",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "AutoHub - Find Your Perfect Vehicle",
    description: "Premium car dealership with flexible financing and exceptional service",
    type: "website",
    siteName: "AutoHub",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_363fycCW5gR5mBuwyI3Zdk1DwTq/uploaded-1764241223928-466107us.jpg",
      alt: "Premium vehicle showcase"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "AutoHub - Premium Cars & Vehicles",
    description: "Discover premium vehicles with exceptional quality and service",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_363fycCW5gR5mBuwyI3Zdk1DwTq/uploaded-1764241223928-466107us.jpg"]
  }
};
